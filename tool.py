...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan][12]: Mở Tất Cả Xe[/bold cyan]")
            console.print("[bold cyan][13]: Mở Còi[/bold cyan]")
            ...
            console.print("[bold cyan][17]: Vô Hạn Xăng [/bold cyan]")
            console.print("[bold cyan][18]: Mở Nhà 3[/bold cyan]")
            console.print("[bold cyan][19]: Mở Khói[/bold cyan]")
            console.print("[bold cyan][20]: Chỉnh Số Thắng[/bold cyan]")
            console.print("[bold cyan][21]: Chỉnh Số Thua[/bold cyan]")
            ...
            if service == 0: # Exit
                ...
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if len(new_id) >= 9 and len(new_id) <= 400 and (' ' in new_id) == False:
                ...
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if len(new_name) >= 0 and len(new_name) <= 60:
